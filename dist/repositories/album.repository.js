...
let AlbumRepository = class AlbumRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, musicRepositoryGetter) {
        super(models_1.Album, dataSource);
...
AlbumRepository = __decorate([
    __param(0, core_1.inject('datasources.db')), __param(1, repository_1.repository.getter('MusicRepository')),
