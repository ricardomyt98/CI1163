...
let Playlist = class Playlist extends repository_1.Entity {
    constructor(data) {
        super(data);
    }
};
...
__decorate([
    ...
    __metadata("design:type", String)
], Playlist.prototype, "mainStyle", void 0);
__decorate([
    repository_1.property({
        type: 'string',
        required: true,
    ...
    __metadata("design:type", String)
], Playlist.prototype, "secStyle", void 0);
__decorate([
    repository_1.property({
        type: 'number',
    }),
    __metadata("design:type", Number)
], Playlist.prototype, "playlistFolderId", void 0);
__decorate([
    repository_1.hasMany(() => music_playlist_model_1.MusicPlaylist),
    __metadata("design:type", Array)
], Playlist.prototype, "musicPlaylists", void 0);
__decorate([
    repository_1.belongsTo(() => playlist_folder_model_1.PlaylistFolder),
    __metadata("design:type", Number)
], Playlist.prototype, "playlistFoldereId", void 0);
Playlist = __decorate([
