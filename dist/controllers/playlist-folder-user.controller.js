...
let PlaylistFolderUserController = class PlaylistFolderUserController {
...
__decorate([
    rest_1.get('/playlist-folders/{id}/user', {
        responses: {
            '200': {
...
], PlaylistFolderUserController.prototype, "getUser", null);
PlaylistFolderUserController = __decorate([
...
], PlaylistFolderUserController);
exports.PlaylistFolderUserController = PlaylistFolderUserController;
//# sourceMappingURL=playlist-folder-user.controller.js.map